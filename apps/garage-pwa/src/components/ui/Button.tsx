...
const VARIANT_CLASSES: Record<Variant, string> = {
  ...
  ghost: "text-primary hover:bg-pulse-50 active:bg-pulse-100",
  danger:
  ...
  function Button(
    ...
    return (
      <button
        ...
        className={cn(
          "tap inline-flex items-center justify-center gap-2 rounded-md font-semibold transition-transform active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
